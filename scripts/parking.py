...
class ParkingManagement(BaseSolution):
    ...
    def process_data(self, im0):
        ...
        for region in self.json:
            ...
            for box, cls in zip(self.boxes, self.clss):
                ...
                if dist >= 0:
                    ...
                    cv2.putText(im0, self.model.names[int(cls)], (xc, yc + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
                    rg_occupied = True
                    break
        ...
        text = f"Occupied: {self.pr_info['Occupancy']} | Available: {self.pr_info['Available']}"
        cv2.putText(im0, text, (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
